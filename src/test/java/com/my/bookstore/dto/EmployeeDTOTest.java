...
public class EmployeeDTOTest {
    ...
    static void setup() throws ClassNotFoundException {
        final Class<?> clazz = Class.forName(com.my.bookstore.dto.Constants.EMPLOYEE_DTO_TYPE);
    ...
    void checkCountConstructors() {
        assertEquals(com.my.bookstore.dto.Constants.EmployeeDTO.CLASS_COUNT_CONSTRUCTORS, allConstructors.size());
    }
    ...
    @Test
    @DisplayName(com.my.bookstore.dto.Constants.EmployeeDTO.CLASS_NAME + " has default constructor")
    ...
    @Test
    @DisplayName(com.my.bookstore.dto.Constants.EmployeeDTO.CLASS_NAME + " has constructor with " + com.my.bookstore.dto.Constants.EmployeeDTO.PARAMETERS_IN_CONSTRUCTOR_WITH_PARAMETERS + " parameters")
    void checkConstructorWithParameter() {
        var count = allConstructors.stream()
                .filter(constructor -> constructor.getParameterCount() == com.my.bookstore.dto.Constants.EmployeeDTO.PARAMETERS_IN_CONSTRUCTOR_WITH_PARAMETERS)
                .count();
    ...
    void checkParameterTypeForConstructorWithParameter() {
        final var constructor = allConstructors.stream()
                .filter(c -> c.getParameterCount() == com.my.bookstore.dto.Constants.EmployeeDTO.PARAMETERS_IN_CONSTRUCTOR_WITH_PARAMETERS)
                .findFirst()
    ...
    void checkCountFields() {
        assertEquals(com.my.bookstore.dto.Constants.EmployeeDTO.CLASS_COUNT_FIELDS, allFields.size());
    }
    ...
    void checkModifiersFields() {
        ...
        assertEquals(com.my.bookstore.dto.Constants.EmployeeDTO.CLASS_COUNT_FIELDS, count);
    }
